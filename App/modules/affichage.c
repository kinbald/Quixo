  ...
  while (index_ligne < TAILLE_PLATEAU) {
    while (index_colonne < TAILLE_PLATEAU) {
      ...
      afficheSymbole(pas, &casePion,
                     getCase(&plateau_jeu, &caseLecture), &caseLecture);
...
void afficheSymbole(float pas, CASE *case_jeu, int joueur, CASE *lectureCase) {
  couleurCourante(239, 240, 244);
  switch (joueur) {
    case croix_droit: afficheCroixPoint(case_jeu, pas, 0);
      break;
    case croix_bas: afficheCroixPoint(case_jeu, pas, 1);
      break;
    case croix_gauche: afficheCroixPoint(case_jeu, pas, 2);
      break;
    case croix_haut: afficheCroixPoint(case_jeu, pas, 3);
      break;
    case rond_droit: afficheRondPoint(case_jeu, pas / 3, 0);
      break;
    case rond_bas: afficheRondPoint(case_jeu, pas / 3, 1);
      break;
    case rond_gauche: afficheRondPoint(case_jeu, pas / 3, 2);
      break;
    case rond_haut: afficheRondPoint(case_jeu, pas / 3, 3);
      break;
    case surbrillance:afficheSurbrillance(case_jeu, pas, lectureCase);
      break;
    case pioche: couleurCourante(210, 210, 210);
  ...
  switch (clicSouris->menu)
  {
    ...
    case redirectSurbrillance:
      if (clicSouris->coordX >= coordonneesPlateau[0]
        ...
        clicPlateau(retourClic, clicSouris,
                           coordonneesPlateau);
      ...
      break;
    default:return redirectCentral;
  }
  return redirectCentral;
}
